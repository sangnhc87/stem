...
\phantomsection\subsection*{2. Giải pháp STEM}\addcontentsline{toc}{subsection}{2. Giải pháp STEM}
...
\phantomsection\subsection*{3. Chuẩn kiến thức}\addcontentsline{toc}{subsection}{3. Chuẩn kiến thức}
\begin{itemize}
